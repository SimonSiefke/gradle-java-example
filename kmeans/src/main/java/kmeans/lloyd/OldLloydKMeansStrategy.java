...
// /**
// * @deprecated Old Lloyd KMeans Strategy.
// */
// public class OldLloydKMeansStrategy implements KMeansStrategy {
// private DistanceStrategy distance;

// @Override
// public Cluster[] cluster(@Nonnull double[][] dataPoints, @Nonnull double[][]
...
// Arrays.stream(initialClusterCenters).map(Cluster::new).toArray(Cluster[]::new);
...
// */
// private Cluster closestCluster(@Nonnull double[] point, @Nonnull Cluster[]
// clusters) {
