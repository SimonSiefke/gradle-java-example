...
public abstract class KMeansStrategyTestBase<T extends KMeansStrategy> {
  ...
  void testFullDatasetWithTwentySevenClusters() {
    ...
    assertArrayEquals(new double[] { 12149.972183588317, 56155.23087621697 }, clusters[0].center, 0.01);
    assertArrayEquals(new double[] { 26094.979423868313, 45393.81069958848 }, clusters[1].center, 0.01);
    assertArrayEquals(new double[] { 30618.047817047816, 59002.2079002079 }, clusters[2].center, 0.01);
    assertArrayEquals(new double[] { 36008.163522012575, 37352.666666666664 }, clusters[3].center, 0.01);
    assertArrayEquals(new double[] { 36128.85196374622, 47653.33836858006 }, clusters[4].center, 0.01);
    assertArrayEquals(new double[] { 44357.7108433735, 46156.114457831325 }, clusters[5].center, 0.01);
    assertArrayEquals(new double[] { 50690.25490196078, 48273.21568627451 }, clusters[6].center, 0.01);
    assertArrayEquals(new double[] { 50698.87804878049, 50582.31707317073 }, clusters[7].center, 0.01);
    assertArrayEquals(new double[] { 51910.882352941175, 42873.94117647059 }, clusters[8].center, 0.01);
    assertArrayEquals(new double[] { 52940.357142857145, 50252.19047619047 }, clusters[9].center, 0.01);
    assertArrayEquals(new double[] { 53084.045454545456, 47628.045454545456 }, clusters[10].center, 0.01);
    assertArrayEquals(new double[] { 53482.75, 42328.65 }, clusters[11].center, 0.01);
    assertArrayEquals(new double[] { 53720.07692307692, 40721.230769230766 }, clusters[12].center, 0.01);
    assertArrayEquals(new double[] { 53924.0625, 36298.8125 }, clusters[13].center, 0.01);
    assertArrayEquals(new double[] { 54184.06451612903, 44306.93548387097 }, clusters[14].center, 0.01);
    assertArrayEquals(new double[] { 54814.96551724138, 42651.06896551724 }, clusters[15].center, 0.01);
    assertArrayEquals(new double[] { 56083.12244897959, 35167.102040816324 }, clusters[16].center, 0.01);
    assertArrayEquals(new double[] { 56121.68421052631, 43928.21052631579 }, clusters[17].center, 0.01);
    assertArrayEquals(new double[] { 56275.64705882353, 41560.23529411765 }, clusters[18].center, 0.01);
    assertArrayEquals(new double[] { 57238.90909090909, 38873.72727272727 }, clusters[19].center, 0.01);
    assertArrayEquals(new double[] { 57441.91111111111, 36566.64444444444 }, clusters[20].center, 0.01);
    assertArrayEquals(new double[] { 58451.46666666667, 34056.3 }, clusters[21].center, 0.01);
    assertArrayEquals(new double[] { 58641.16, 59852.84 }, clusters[22].center, 0.01);
    assertArrayEquals(new double[] { 59669.61111111111, 45979.38888888889 }, clusters[23].center, 0.01);
    assertArrayEquals(new double[] { 60343.15, 52924.2 }, clusters[24].center, 0.01);
    assertArrayEquals(new double[] { 60563.350877192985, 49512.17543859649 }, clusters[25].center, 0.01);
